...
seo_short_title: SDD 四大流派拆解：AI 编程的规范革命
date: 2026-06-06
categories: [AI]
...
说实话，我被「vibe coding」坑过。

去年有个项目，需求一股脑丢给 AI，一顿 prompt 猛如虎，三天后回头看代码，**重复代码没抽离**、**各种any大法好**、**公共方法未复用**、**代码规范和风格不统一**，功能测试验证？不存在的。那一刻才意识到：**不是 AI 不够强，是我没给 AI 一个「工程框架」**。
