...
function c(e, n, i) {
    ...
    switch (t.substring(o + 1)) {
        ...
        case 'cancel':
            ...
            break;
        default:
            process.env.ENV !== 'prod' && C.debug && !i.isInnerInvoke && console.warn('出错了：' + JSON.stringify(n));
            i.fail && i.fail(n);
    }
...
function s(e, n) {
    ...
    if (n) {
        ...
        (o = (o = o.replace(/_/g, ' ')).toLowerCase()) != 'access denied' && o != 'no permission to execute' || (o = 'permission denied');
...
function f(n) {
    if (k) {
        if (e.WeixinJSBridge) {
            if (I.__wxjsjs__isPreInject === 'preInject') {
...
var w = !(!_.match('mac') && !_.match('win'));
var T = y.indexOf('wxdebugger') != -1;
var k = y.indexOf('micromessenger') != -1;
var M = y.indexOf('android') != -1;
var P = y.indexOf('iphone') != -1 || y.indexOf('ipad') != -1;
var x = (function() {
...
var N = {
    ...
    ready: function(e) {
        B.state != 0 ? e() : (L._completes.push(e), !k && C.debug && e());
    },
    error: function(e) {
    ...
    miniProgram: {
        ...
        getEnv: function(n) {
            f(function() {
                n({
                    miniprogram: e.__wxjs_environment === 'miniprogram'
                });
            });
        }
    }
...
I.addEventListener('error', function(e) {
    if (!M) {
        ...
        var i = n.tagName;
        var t = n.src;
        if ((i == 'IMG' || i == 'VIDEO' || i == 'AUDIO' || i == 'SOURCE') && t.indexOf('wxlocalresource://') != -1) {
