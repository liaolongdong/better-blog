new Vue({
  ...
  methods: {
    ...
    _bindEvent() {
      ...
      let bottomPx = parseFloat(window.getComputedStyle($mineBtn, null).bottom) || 0;
      ...
      $mineBtn.addEventListener("touchmove", function(e) {
        ...
        if (e.touches.length > 0) {
          let offsetX = e.touches[0].pageX - that.mineBtnPos.startX, offsetY = e.touches[0].pageY - that.mineBtnPos.startY;
          let x = that.mineBtnPos.x - offsetX, y = that.mineBtnPos.y - offsetY;
